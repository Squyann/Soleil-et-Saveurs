-- Frais de livraison FIXES : gratuit dès 40€ de sous-total, sinon 2,50€.
-- Remplace l'ancien calcul dégressif (2.50 * (30 - sous_total) / 20) par un
-- montant fixe, et passe le seuil de gratuité de 30€ à 40€.
-- Seul le bloc de calcul des frais change dans creer_commande ; le reste de
