...
export default function Home() {
  ...
  const selectionnerAdresse = (feat: any) => {
    ...
    setTimeout(() => {
      ...
      if (estDansLesYvelines(feat.properties)) {
                ...
                <div className="bg-white border border-slate-100 p-1.5 rounded-[2rem] shadow-xl shadow-slate-200/60 relative">
                  ...
                  {distanceValide === false && (
                    <div className="mx-2 mt-2 p-3 bg-red-50 rounded-xl text-red-600 flex items-center gap-2 animate-in fade-in zoom-in-95">
                      ...
                      <p className="text-[10px] font-black uppercase">Désolé, nous livrons uniquement dans les Yvelines (78).</p>
                    </div>
                  )}
                </div>
                <p className="text-[10px] text-slate-400 px-4 italic font-semibold">📍 Livraison dans tout le département des Yvelines (78)</p>
              </div>
            </div>
      ...
      <section className="max-w-6xl mx-auto px-4 md:px-8 py-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-[#FFF5F1] rounded-[2rem] p-8 min-h-[180px] flex flex-col justify-center border border-orange-100 shadow-xl shadow-orange-50">
            ...
            <p className="text-slate-600 text-sm font-medium">Livraison dans tout le département des Yvelines (78).</p>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-4 md:px-8 py-10">
        <div className="bg-white rounded-[3rem] overflow-hidden shadow-2xl shadow-slate-200 border border-slate-50 grid lg:grid-cols-2">
          <div className="p-10 md:p-14 flex flex-col justify-center">
            ...
            <p className="text-sm text-slate-500 mb-8 font-semibold italic leading-relaxed">Livraison dans toutes les Yvelines (78). L'ultra-local est notre priorité.</p>
